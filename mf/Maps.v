...
Proof.
  intros A m x1 x2 v H.
   unfold t_update. destruct (eqb_spec x1 x2) as [H' | H'].
   - contradiction.
   - reflexivity.
Qed.
...
Proof.
  ...
  unfold t_update. destruct (eqb_spec x x') as [H' | H'].
  - reflexivity.
  - reflexivity.
Qed.
...
Proof.
  ...
  apply functional_extensionality. intros x'.
  unfold t_update. destruct (eqb_spec x1 x') as [H' | H'].
  - destruct (eqb_spec x2 x') as [H'' | H''].
